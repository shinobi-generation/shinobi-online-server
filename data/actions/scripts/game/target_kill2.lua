...
local config = {
   enter = {x=2576,y=1703,z=8},
   exit = {x=2578,y=1703,z=8},
   clock = {time=60},
   totalPoses = registrePosesBetween({x=2570,y=1700,z=8}, {x=2574,y=11706,z=8}), --top LEFT position, under RIGHT position
...
local function stop(isWin, exit)
   ...
   if isPlayer(cid) then
      ...
      setPlayerStorageValue(cid, "hasActiveInQuest2", -1)
