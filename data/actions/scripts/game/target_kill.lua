...
local config = {
   enter = {x=2576,y=1696,z=8},
   exit = {x=2578,y=1696,z=8},
   clock = {time=60},
   totalPoses = registrePosesBetween({x=2570,y=1692,z=8}, {x=2574,y=1698,z=8}), --top LEFT position, under RIGHT position
   nameQuest = "cidShootingOne",
   isActive = false,
   maxLevel = 100,
