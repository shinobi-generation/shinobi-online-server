...
local PQUANT = 80 -- Quantidade de premio
...
if getPlayerStorageValue(cid,sto_missao[1]) == 6 and getPlayerItemCount(cid,ITEM) >= 20 then
...
setPlayerStorageValue(cid, sto_missao[1], 7)
setPlayerStorageValue(cid, sto_missao[7], os.time() + 1*60*60*24)
npcHandler:say('Obrigado', cid)
elseif getPlayerStorageValue(cid,sto_missao[1]) >= 6 then
