function onSay(cid, words, param, channel)
    ...
    doPlayerPopupFYI(cid, "Information about player" ..
            ...
            "\nSkills:" ..
            "\nFist - " .. getPlayerSkillLevel(pid, SKILL_TAIJUTSU) .. ", Club - " .. getPlayerSkillLevel(pid, SKILL_NINJUTSU) .. ", Sword - " .. getPlayerSkillLevel(pid, SKILL_GENJUTSU) .. ", Axe - " .. getPlayerSkillLevel(pid, SKILL_MELEE) ..
