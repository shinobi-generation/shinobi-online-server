...
function isInArray3(array, array2)
    -- Function by Ramza (Ricardo Ianelli)
    local x = array2[1]
    local y = array2[2]
...
function getPlayerMeleeSkill(cid)
    return { [0] = getPlayerSkillLevel(cid, SKILL_TAIJUTSU), [1] = getPlayerSkillLevel(cid, SKILL_NINJUTSU), [2] = getPlayerSkillLevel(cid, SKILL_GENJUTSU), [3] = getPlayerSkillLevel(cid, SKILL_MELEE) }
end
...
function getFirstCreaturePosOnDirection(cid, distance)
    -- By: Lwkass
